...
exports.triggerEvaluation = void 0;
...
function triggerEvaluation(token, resourceIds) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (operationRes.status !== enum_1.AsyncStatus.SUCCEEDED) {
            throw new Error(`trigger evaluation failed, code: ${(_a = operationRes.error) === null || _a === void 0 ? void 0 : _a.code}, message: ${(_b = operationRes.error) === null || _b === void 0 ? void 0 : _b.message}`);
        }
